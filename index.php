	...
	<body>
		...
		<section id="brands">
			...
			<div class="container">
				...
				<img src="assets/img/1.png" alt="1" class="picture">
				<img src="assets/img/2.png" alt="2" class="picture">
				<img src="assets/img/3.png" alt="3" class="picture">
				<img src="assets/img/4.png" alt="4" class="picture">
			</div>
		...
		<!-- FOOTER -->
		<footer>
			<img src="assets/img/logo2.png" alt="logo" id="logo"><br>
			2018 © Bitly<br>
